...
public class SharedDriver extends EventFiringWebDriver{
	...
	static {
		System.setProperty("webdriver.chrome.driver", "G:\\KiwiQA Automation Projects\\OWLS\\GIT\\OWLS_Automation\\Resource\\chromedriver_2_33.exe");
	}
	...
	protected static final Thread CLOSE_THREAD = new Thread() {
        @Override
        public void run() {
        	driver.close();
        }
